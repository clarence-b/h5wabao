<?php exit;?>001506691300512c3b1db9373859aa21bcc42b02b52ds:1766:"a:2:{s:8:"template";s:1702:"<!doctype html>
<html>
<head>
    <meta charset="utf-8">
...
<body>
	<div class="layout">
		...
		<?php $n=1;if(is_array($trace)) foreach($trace as $k=>$v) { ?>
			#<?php echo $k; ?> <?php echo $v['file']; ?>(<?php echo $v['line']; ?>) <?php echo $v['class']; ?><?php echo $v['type']; ?><?php echo $v['function']; ?>() <br>
		<?php $n++;}unset($n); ?>
		</div>
		<div class="error_tip">您可以选择 &nbsp;&nbsp;<a href="javascript:history.back()" title="返回">返回</a>&nbsp;&nbsp;或者&nbsp;&nbsp;<a href="<?php echo ROOT_URL;?>" title="回到首页">回到首页</a> </div>
	</div>
</body>
</html>";s:12:"compile_time";i:1475155300;}";