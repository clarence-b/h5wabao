<?php exit;?>0015068863650aef8ee2c82d98d5f4da79a1e58dd2e6s:4042:"a:2:{s:8:"template";s:3978:"<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <img id="pathimg" data-src="<?php echo ROOT_URL;?>share.jpg" alt="“丰”收赢大奖">
    ...
    <section id="page1">
        <img data-src="<?php echo PUBLIC_URL;?>assets/images/01_page_bg.jpg" class="bg">
    ...
    <section id="page2" class="hide">
        ...
        <img data-src="<?php echo PUBLIC_URL;?>assets/images/02_page_bg.jpg" class="bg">
...
</html>";s:12:"compile_time";i:1475350365;}";